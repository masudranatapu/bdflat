...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2021 at 08:04 AM
...
CREATE TABLE `ACC_CUSTOMER_PAYMENT_USED` (
  `PK_NO` int(11) NOT NULL,
...
CREATE TABLE `ACC_CUSTOMER_TRANSACTION` (
  ...
  `TRANSACTION_TYPE` int(11) NOT NULL DEFAULT 1 COMMENT '1 = recharge',
...
INSERT INTO `ACC_CUSTOMER_TRANSACTION` (`PK_NO`, `CODE`, `F_CUSTOMER_NO`, `F_CUSTOMER_PAYMENT_NO`, `AMOUNT`, `TRANSACTION_DATE`, `TRANSACTION_TYPE`, `IN_OUT`, `F_SS_CREATED_BY`, `SS_CREATED_ON`, `F_SS_MODIFIED_BY`, `SS_MODIFIED_ON`) VALUES
(2, 1001, 14, 18, 100, '2021-08-03', 1, 1, NULL, '2021-08-12 02:38:16', NULL, '2021-08-12 02:38:16'),
(3, 1002, 14, 19, 120, '2021-08-15', 1, 1, NULL, '2021-08-15 00:46:09', NULL, '2021-08-15 00:46:09'),
(4, 1003, 18, 20, 15, '2021-08-18', 1, 1, 2, '2021-08-18 00:42:31', NULL, '2021-08-18 00:42:31'),
(5, 1004, 19, 21, 500, '2021-08-20', 1, 1, 2, '2021-08-20 01:03:29', NULL, '2021-08-20 01:03:29'),
(6, 1005, 19, 22, 50, '2021-08-20', 1, 1, 2, '2021-08-20 01:06:29', NULL, '2021-08-20 01:06:29'),
(7, 1006, 19, 23, 10, '2021-08-20', 1, 1, 2, '2021-08-20 01:14:25', NULL, '2021-08-20 01:14:25'),
(8, 1007, 15, 24, 500, '2021-08-20', 1, 1, 2, '2021-08-20 01:16:17', NULL, '2021-08-20 01:16:17');
...
DECLARE VAR_AMOUNT INT(10) DEFAULT NULL;

SELECT IFNULL(SUM(AMOUNT),0) INTO VAR_AMOUNT FROM ACC_CUSTOMER_TRANSACTION;
...
INSERT INTO `PRD_LISTINGS` (`PK_NO`, `CODE`, `PROPERTY_FOR`, `F_PROPERTY_TYPE_NO`, `PROPERTY_TYPE`, `ADDRESS`, `PROPERTY_CONDITION`, `F_PROPERTY_CONDITION`, `PROPERTY_SIZE`, `BEDROOM`, `BATHROOM`, `TOTAL_PRICE`, `PRICE_TYPE`, `TITLE`, `URL_SLUG`, `URL_SLUG_LOCKED`, `F_CITY_NO`, `CITY_NAME`, `F_AREA_NO`, `AREA_NAME`, `F_USER_NO`, `USER_TYPE`, `CONTACT_PERSON1`, `CONTACT_PERSON2`, `MOBILE1`, `MOBILE2`, `F_LISTING_TYPE`, `LISTING_TYPE`, `F_PREP_TENANT_NO`, `PREP_TENANT`, `AVAILABLE_FROM`, `GENDER`, `IS_VERIFIED`, `VERIFIED_BY`, `VERIFIED_AT`, `CREATED_AT`, `CREATED_BY`, `MODIFIED_AT`, `MODIFIED_BY`, `TOTAL_FLOORS`, `FLOORS_AVAIABLE`, `IS_FEATURE`, `EXPAIRED_AT`, `STATUS`, `PAYMENT_STATUS`, `CI_PAYMENT`, `IS_TOP`) VALUES
(5, 1001, 'sell', 1, 'Apartment', 'Banasree, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 1, '1690 sqft, 3 Beds Under Construction Apartment/Flats for Sale at Banasree', '1690-sqft-3-beds-under-construction', 0, 1, 'Dhaka', 7, ' Banasree', 15, 3, 'Hyperion Design & Development Ltd.', 'Hyperion Design & Development Ltd.', '01817158000', '01817158000', 2, 'Feature Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-03 20:35:32', 15, '2021-08-25 19:42:48', 15, 6, '[\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 1),
(6, 1002, 'sell', 1, 'Apartment', 'Eskaton, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 1, '1478 sqft, 3 Beds Under Construction Apartment/Flats for Sale at Eskaton', '1478-sqft-3-beds-under-construction', 1, 1, 'Dhaka', 8, 'Eskaton', 15, 3, 'Runner Properties Ltd.', 'Runner Properties Ltd.', '01730406', '01730406', 2, 'Feature Listing for 30 days', NULL, NULL, NULL, NULL, 1, NULL, NULL, '2021-08-03 20:49:12', 15, '2021-08-25 19:42:41', 15, 6, '[\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 1, 0),
(7, 1003, 'sell', 2, 'Office', 'Uttara, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 1, '2500 sqft, Under Construction Office Space for Sale at Uttara', '2500-sqft-under-construction', 0, 1, 'Dhaka', 9, 'Uttara', 13, 2, 'Ark Builders Ltd', 'Ark Builders Ltd', '01926993000', '01926993000', 3, 'General Listing with daily auto update f', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-03 21:02:31', 13, '2021-08-20 23:21:38', 2, 6, '[\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(8, 1004, 'rent', 1, 'Apartment', 'Rampura, Dhaka', 'Ready', 1, '0', 0, 0, '0', 1, '1800 sqft, 3 Beds Apartment/Flats for Rent at Rampura', '1800-sqft-under-construction', 0, 1, 'Dhaka', 10, 'Rampura', 13, 2, 'Rayyan Properties', 'Rayyan Properties', '01300773000', '01300773000', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-03 21:07:11', 13, '2021-08-20 23:21:38', 2, 6, '[\"6\"]', 0, NULL, 0, 0, 0, 0),
(9, 1005, 'rent', 2, 'Office', 'Hyperion Tower, House - 02, Block - A, Road - 04, Section - 10Mirpur, Dhaka-1216', 'Ready', 1, '0', 0, 0, '0', 1, '3500 sqft, Office Space for Rent at Mirpur 10', '3500-sqft-office-space', 0, 1, 'Dhaka', 1, 'Mirpur', 16, 4, 'Arafatul Alam', 'Arafatul Alam', '01817158000', '01817158000', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-04 15:34:14', 16, '2021-08-20 23:21:38', 2, 6, '[\"2\",\"3\"]', 0, NULL, 0, 0, 0, 0),
(10, 1006, 'rent', 1, 'Apartment', 'Mirbag, Dhaka', 'Ready', 1, '0', 0, 0, '0', 1, '16000 sqft, 6 Beds Duplex Home for Rent at Mirbag', '16000-sqft-6-beds-duplex-home', 0, 1, 'Dhaka', 11, 'Mirbag', 16, 4, 'Tallal Ziad', 'Tallal Ziad', '20100139292', '20100139292', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-04 15:41:35', 16, '2021-08-20 23:21:38', 2, 3, '[\"2\",\"3\"]', 0, NULL, 0, 0, 0, 0),
(11, 1007, 'rent', 1, 'Apartment', 'BLOCK C, ROAD 2, HOUSE 1F', 'Ready', 1, '0', 0, 0, '0', 1, '400 sqft, 2 Beds Studio Apartment for Rent at Bashundhara R/A', '400-sqft-2-beds-studio-apartment', 0, 1, 'Dhaka', 12, 'Basundhara', 16, 4, 'MUSFAQUE RAIHAN MUSA', 'MUSFAQUE RAIHAN MUSA', '01712503000', '01712503000', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-04 18:59:39', 16, '2021-08-20 23:21:38', 2, 6, '[\"6\"]', 0, NULL, 0, 0, 0, 0),
(12, 1008, 'rent', 1, 'Apartment', 'Shewrapara', 'Ready', 1, '0', 0, 0, '0', 1, '500 sqft, 1 Bed Sublet/Room for Rent at Shewrapara', '500-sqft-2-beds-studio-apartment', 0, 1, 'Dhaka', 1, 'Mirpur', 16, 4, 'Shahid Sajjad Huq', 'Shahid Sajjad Huq', '01977149000', '01977149000', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-04 19:03:12', 16, '2021-08-20 23:21:38', 2, 1, '[\"1\"]', 0, NULL, 0, 0, 0, 0),
(13, 1009, 'roommate', 1, 'Apartment', 'house : 22. road : 3. block : E. section : 12. Pallabi. Mirpur', 'Ready', 1, '0', 0, 0, '0', 1, 'sublet Female for a Roommates at Mirpur 12', 'sublet-female-roommate', 0, 1, 'Dhaka', 1, 'Mirpur', 17, 5, 'Effat ara', 'Effat ara', '01739252000', '01739252000', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-04 19:37:05', 17, '2021-08-20 23:21:38', 2, 6, '[\"3\"]', 0, NULL, 0, 0, 0, 0),
(14, 1010, 'roommate', 1, 'Apartment', 'Aftab Nagar', 'Ready', 1, '0', 0, 0, '0', 1, 'Hostel Male for a Roommates/Paying Guest at Aftab Nagar', 'hostel-male-roommate', 1, 1, 'Dhaka', 10, 'Rampura', 17, 5, 'Super Hostel BD', 'Super Hostel BD', '016784038820', '1678403884', 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-04 19:48:22', 17, '2021-08-20 23:21:38', 2, 6, NULL, 0, NULL, 0, 0, 0, 0),
(15, 1011, 'sell', 1, 'Apartment', 'Cantonment, Dhaka', 'Ready', 1, '0', 0, 0, '0', 2, '1125 sqft, 3 Beds Ready Studio Apartment for Sale at Cantonment', '1125-sqft-3-beds-ready-studio-apartment-for-sale-at-cantonment', 0, 1, 'Dhaka', 1, 'Mirpur', 13, 2, 'Rafath', NULL, '01717164000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 16:09:00', 13, '2021-08-26 16:09:00', NULL, 6, '[\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(16, 1012, 'sell', 1, 'Apartment', 'Bashundhara R/A, Dhaka', 'Ready', 1, '0', 0, 0, '0', 2, '2300 sqft, 3 Beds Ready Flats for Sale at Bashundhara R/A', '2300-sqft-3-beds-ready-flats-for-sale-at-bashundhara-ra', 0, 1, 'Dhaka', 12, 'Basundhara', 13, 2, 'IMAGINE PROPERTIES LTD.', NULL, '01939919000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 16:16:04', 13, '2021-08-26 16:16:04', NULL, 6, '[\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(17, 1013, 'rent', 2, 'Office', '61, Bijoy nagar, Dhaka', 'Ready', 1, '0', 0, 0, '0', 1, '2000 sqft, Office Space for Rent at Naya Paltan', '2000-sqft-office-space-for-rent-at-naya-paltan', 0, 1, 'Dhaka', 13, 'Naya Paltan', 21, 2, 'IMAGINE PROPERTIES LTD', NULL, '01939919000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 16:27:30', 21, '2021-08-26 16:27:30', NULL, 6, '[\"2\"]', 0, NULL, 0, 0, 0, 0),
(18, 1014, 'sell', 1, 'Apartment', 'Basundhara R/A, Dhaka', 'Ready', 1, '0', 0, 0, '0', 2, '2935 sqft, 4 Beds Ready Flats for Sale at Bashundhara R/A', '2935-sqft-4-beds-ready-flats-for-sale-at-bashundhara-ra', 0, 1, 'Dhaka', 12, 'Basundhara', 21, 2, 'IMAGINE PROPERTIES LTD.', NULL, '01939919000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 16:54:10', 21, '2021-08-26 16:54:10', NULL, 6, '[\"2\"]', 0, NULL, 0, 0, 0, 0),
(19, 1015, 'sell', 1, 'Apartment', '2300 sqft, 3 Beds Ready Flats for Sale at Bashundhara R/A  SALE', 'Ready', 1, '0', 0, 0, '0', 1, '2300 sqft, 3 Beds Ready Flats for Sale at Bashundhara R/A', '2300-sqft-3-beds-ready-flats-for-sale-at-bashundhara-ra-1015', 0, 1, 'Dhaka', 12, 'Basundhara', 21, 2, 'IMAGINE PROPERTIES LTD', NULL, '01939919000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 17:03:37', 21, '2021-08-26 17:03:37', NULL, 6, '[\"6\"]', 0, NULL, 0, 0, 0, 0),
(20, 1016, 'sell', 1, 'Apartment', 'Bashundhara R/A , Dhaka', 'Ready', 1, '0', 0, 0, '0', 2, '2300 sqft, 3 Beds Ready Flats for Sale at Bashundhara R/A', '2300-sqft-3-beds-ready-flats-for-sale-at-bashundhara-ra-1016', 0, 1, 'Dhaka', 12, 'Basundhara', 21, 2, 'IMAGINE PROPERTIES LTD.', NULL, '01939919000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 17:13:38', 21, '2021-08-26 17:13:38', NULL, 6, '[\"1\",\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(21, 1017, 'sell', 1, 'Apartment', 'Adabor , Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 2, '1600 sqft, 4 Beds Under Construction Apartment/Flats for Sale at Adabor', '1600-sqft-4-beds-under-construction-apartmentflats-for-sale-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 17:36:25', 22, '2021-08-26 17:36:25', NULL, 6, '[\"3\",\"4\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(22, 1018, 'rent', 3, 'Shop', 'House#13-23,Road #01 Janata Co-Operative Housing Society Ltd. Ring Road,Adabor,Dhaka-1207', 'Ready', 1, '0', 0, 0, '0', 1, '125 sqft, Showroom/Shop/Restaurant for Rent at Adabor', '125-sqft-showroomshoprestaurant-for-rent-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 17:44:48', 22, '2021-08-26 17:44:48', NULL, 4, '[\"1\",\"2\"]', 0, NULL, 0, 0, 0, 0),
(23, 1019, 'rent', 2, 'Office', 'SHAHABUDDIN PLAZA,House:13-23,Road#01,Janata Co-Operative Housing Society Ltd.Ring Road,Adabor Dhaka-1207', 'Ready', 1, '0', 0, 0, '0', 2, '1100 sqft, Office Space for Rent at Adabor', '1100-sqft-office-space-for-rent-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 17:58:41', 22, '2021-08-26 17:58:41', NULL, 6, '[\"5\"]', 0, NULL, 0, 0, 0, 0),
(24, 1020, 'sell', 1, 'Apartment', 'Adabor, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 2, '1438 sqft, 3 Beds Under Construction Apartment/Flats for Sale at Adabor', '1438-sqft-3-beds-under-construction-apartmentflats-for-sale-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 18:43:18', 22, '2021-08-26 18:43:18', NULL, 6, '[\"3\"]', 0, NULL, 0, 0, 0, 0),
(25, 1021, 'sell', 1, 'Apartment', 'Adabor, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 1, '1912 sqft, 4 Beds Under Construction Apartment/Flats for Sale at Adabor', '1912-sqft-4-beds-under-construction-apartmentflats-for-sale-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 19:32:05', 22, '2021-08-26 19:32:05', NULL, 6, '[\"2\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(26, 1022, 'rent', 2, 'Office', 'Adabor, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 2, '700 sqft, Office Space for Rent at Adabor', '700-sqft-office-space-for-rent-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 19:40:15', 22, '2021-08-26 19:40:15', NULL, 6, '[\"5\"]', 0, NULL, 0, 0, 0, 0),
(27, 1023, 'rent', 3, 'Shop', 'Adabor, Dhaka', 'Ready', 1, '0', 0, 0, '0', 1, '264 sqft, Shop for Rent at Adabor', '264-sqft-shop-for-rent-at-adabor', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 19:48:02', 22, '2021-08-26 19:48:02', NULL, 6, '[\"1\",\"2\"]', 0, NULL, 0, 0, 0, 0),
(28, 1024, 'sell', 1, 'Apartment', 'Mirpur 14, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 2, '1980 sqft, 3 Beds Under Construction Flats for Sale at Mirpur 14', '1980-sqft-3-beds-under-construction-flats-for-sale-at-mirpur-14', 0, 1, 'Dhaka', 1, 'Mirpur', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 19:56:52', 22, '2021-08-26 19:56:52', NULL, 6, '[\"3\",\"5\"]', 0, NULL, 0, 0, 0, 0),
(29, 1025, 'rent', 3, 'Shop', 'Adabor', 'Ready', 1, '0', 0, 0, '0', 1, '1000 sqft, Shop for Rent at Adabor  RENT', '1000-sqft-shop-for-rent-at-adabor-rent', 0, 1, 'Dhaka', 14, 'Adabor', 22, 2, 'Lucky Engineering Limited', NULL, '01312131000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 20:41:20', 22, '2021-08-26 20:41:20', NULL, 4, '[\"2\",\"3\"]', 0, NULL, 0, 0, 0, 0),
(30, 1026, 'rent', 2, 'Office', 'Narayangonj Sadar , Narayanganj', 'Ready', 1, '0', 0, 0, '0', 1, 'Commercial Space for Rent at Bangabandhu Road, Narayangonj.', 'commercial-space-for-rent-at-bangabandhu-road-narayangonj', 0, 4, 'Narayanganj', 15, 'Narayanganj Sadar', 23, 2, 'Rafiqul Islam Ratul', NULL, '01709659000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 20:50:13', 23, '2021-08-26 20:50:13', NULL, 5, '[\"1\"]', 0, NULL, 0, 0, 0, 0),
(31, 1027, 'sell', 1, 'Apartment', 'Malibag, Dhaka', 'Ready', 1, '0', 0, 0, '0', 2, '1290 sqft, 3 Beds Ready Apartment/Flats for Sale at Malibag', '1290-sqft-3-beds-ready-apartmentflats-for-sale-at-malibag', 0, 1, 'Dhaka', 16, 'Malibag', 24, 2, 'RAYYAN PROPERTIES', NULL, '01300773000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 20:55:54', 24, '2021-08-26 20:55:54', NULL, 6, '[\"3\"]', 0, NULL, 0, 0, 0, 0),
(32, 1028, 'sell', 1, 'Apartment', 'Basundhara R/A, Dhaka', 'Ongoing', 3, '0', 0, 0, '0', 2, 'সুলভ মূল্যে জমির অংশ কিনুন এবং বসুন্ধরা আ/এ-তে নির্মাণ ব্যয়ে আপনার অ্যাপার্টমেন্ট তৈরি করুন', '', 0, 1, 'Dhaka', 12, 'Basundhara', 24, 2, 'RAYYAN PROPERTIES', NULL, '01300773000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 20:58:29', 24, '2021-08-26 20:58:29', NULL, 6, '[\"2\",\"3\"]', 0, NULL, 0, 0, 0, 0),
(33, 1029, 'sell', 1, 'Apartment', 'Mirpur 6', 'Ongoing', 3, '0', 0, 0, '0', 1, '1590 sqft, 3 Beds Under Construction Flats for Sale at Mirpur 6', '1590-sqft-3-beds-under-construction-flats-for-sale-at-mirpur-6', 0, 1, 'Dhaka', 1, 'Mirpur', 24, 2, 'RAYYAN PROPERTIES', NULL, '01300773000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 21:00:30', 24, '2021-08-26 21:00:30', NULL, 6, '[\"6\"]', 0, NULL, 0, 0, 0, 0),
(34, 1030, 'sell', 1, 'Apartment', 'Baridhara', 'Ready', 1, '0', 0, 0, '0', 2, '2480 sqft, 4 Beds Ready Apartment/Flats for Sale at Baridhara', '2480-sqft-4-beds-ready-apartmentflats-for-sale-at-baridhara', 0, 1, 'Dhaka', 17, 'Baridhara', 24, 2, 'RAYYAN PROPERTIES', NULL, '01300773000', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-26 21:03:04', 24, '2021-08-26 21:03:04', NULL, 6, '[\"3\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(35, 1031, 'sell', 7, 'Land', 'Purbachal', 'Ready', 1, '0', 0, 0, '0', 2, '3 katha,Residential Plot for Sale at Purbachal', '3-katharesidential-plot-for-sale-at-purbachal', 0, 1, 'Dhaka', 18, 'Purbachal', 25, 2, 'Purbachal Marine City', NULL, '01345217032', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 18:05:48', 25, '2021-08-27 18:05:48', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(36, 1032, 'rent', 7, 'Land', 'Purbachal', 'Ready', 1, '0', 0, 0, '0', 1, '5 katha, Ready Residential Plot for Sale at Purbachal', '5-katha-ready-residential-plot-for-sale-at-purbachal', 0, 1, 'Dhaka', 18, 'Purbachal', 25, 2, 'Purbachal Marine City', NULL, '01345217032', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 18:47:15', 25, '2021-08-27 18:47:15', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(37, 1033, 'rent', 7, 'Land', 'Purbachal', 'Ready', 1, '0', 0, 0, '0', 1, 'Rare plot at Vip sector_17, 3 katha, Ready Residential Plot for Sale at Purbachal', 'rare-plot-at-vip-sector-17-3-katha-ready-residential-plot-for-sale-at-purbachal', 0, 1, 'Dhaka', 18, 'Purbachal', 25, 2, 'Purbachal Marine City', NULL, '01345217032', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:10:10', 25, '2021-08-27 19:10:10', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(38, 1034, 'sell', 7, 'Land', 'Savar', 'Semi Ready', 2, '0', 0, 0, '0', 1, '5 katha, Almost Ready Residential Plot for Sale at Savar', '5-katha-almost-ready-residential-plot-for-sale-at-savar', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:21:35', 26, '2021-08-27 19:21:35', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(39, 1035, 'sell', 7, 'Land', 'Hemayetpur', 'Ready', 1, '0', 0, 0, '0', 1, '5 katha, Ready Residential Plot for Sale at Hemayetpur', '5-katha-ready-residential-plot-for-sale-at-hemayetpur', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:30:02', 26, '2021-08-27 19:30:02', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(40, 1036, 'sell', 7, 'Land', 'Hemayetpur', 'Ready', 1, '0', 0, 0, '0', 1, '10 katha, Ready Residential Plot for Sale at Hemayetpur', '10-katha-ready-residential-plot-for-sale-at-hemayetpur', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:34:17', 26, '2021-08-27 19:34:17', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(41, 1037, 'sell', 7, 'Land', 'Hemayetpur', 'Ready', 1, '0', 0, 0, '0', 1, '5 katha, Almost Ready Residential Plot for Sale at Savar', '5-katha-almost-ready-residential-plot-for-sale-at-savar-1037', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:38:37', 26, '2021-08-27 19:38:37', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(42, 1038, 'sell', 7, 'Land', 'Savar', 'Ready', 1, '0', 0, 0, '0', 1, '10 katha, Under Development Residential Plot for Sale at Savar', '10-katha-under-development-residential-plot-for-sale-at-savar', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:42:08', 26, '2021-08-27 19:42:08', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(43, 1039, 'sell', 7, 'Land', 'Savar', 'Ready', 1, '0', 0, 0, '0', 1, '3 katha, Under Development Residential Plot for Sale at Savar', '3-katha-under-development-residential-plot-for-sale-at-savar', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:44:58', 26, '2021-08-27 19:44:58', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(44, 1040, 'sell', 7, 'Land', 'savar', 'Ready', 1, '0', 0, 0, '0', 1, '3 katha, Under Development Residential Plot for Sale at Savar', '3-katha-under-development-residential-plot-for-sale-at-savar-1040', 0, 1, 'Dhaka', 19, 'Savar', 26, 2, 'Rifat Al Islam', NULL, '01923847564', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:48:16', 26, '2021-08-27 19:48:37', NULL, NULL, NULL, 0, NULL, 4, 0, 0, 0),
(45, 1041, 'sell', 7, 'Land', 'Narayangonj Sadar, Narayanganj', 'Ready', 1, '0', 0, 0, '0', 1, '4 katha, Under Development Residential Plot for Sale at Narayangonj Sadar', '4-katha-under-development-residential-plot-for-sale-at-narayangonj-sadar', 0, 4, 'Narayanganj', 15, 'Narayanganj Sadar', 27, 2, 'Tarikul Islam', NULL, '01484773892', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 19:59:18', 27, '2021-08-27 19:59:18', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(46, 1042, 'sell', 1, 'Apartment', 'Basundhara', 'Ongoing', 3, '0', 0, 0, '0', 1, '1675 sqft, 3 Beds Under Construction Apartment/Flats for Sale at Bashundhara R/A', '1675-sqft-3-beds-under-construction-apartmentflats-for-sale-at-bashundhara-ra', 0, 1, 'Dhaka', 12, 'Basundhara', 27, 2, 'Tarikul Islam', NULL, '01484773892', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 20:06:11', 27, '2021-08-27 20:06:11', NULL, 6, '[\"1\",\"2\",\"3\",\"4\",\"5\",\"6\"]', 0, NULL, 0, 0, 0, 0),
(47, 1043, 'rent', 7, 'Land', 'Badda', 'Ongoing', 3, '0', 0, 0, '0', 1, '3-10 katha, Rajuk Approved Ready Residential Plot for Sale at Satarkul, Badda.', '3-10-katha-rajuk-approved-ready-residential-plot-for-sale-at-satarkul-badda', 0, 1, 'Dhaka', 20, 'Badda', 28, 2, 'ismail munna', NULL, '01708042445', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 20:21:31', 28, '2021-08-27 20:21:31', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(48, 1044, 'sell', 7, 'Land', 'Basundhara', 'Ready', 1, '0', 0, 0, '0', 1, '4 katha, Ready Residential Plot for Sale at Bashundhara R/A', '4-katha-ready-residential-plot-for-sale-at-bashundhara-ra', 0, 1, 'Dhaka', 12, 'Basundhara', 29, 2, 'anur mia', NULL, '01928374854', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 20:28:41', 29, '2021-08-27 20:28:41', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(49, 1045, 'sell', 7, 'Land', 'Aftab nagar', 'Ready', 1, '0', 0, 0, '0', 1, '3 katha, Ready Residential Plot for Sale at Aftab Nagar', '3-katha-ready-residential-plot-for-sale-at-aftab-nagar', 0, 1, 'Dhaka', 21, 'Aftab Nagar', 30, 2, 'Shah', NULL, '01982737464', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 20:38:26', 30, '2021-08-27 20:38:26', NULL, NULL, NULL, 0, NULL, 0, 0, 0, 0),
(50, 1046, 'roommate', 1, 'Apartment', 'Mirpur 12', 'Ready', 1, '0', 0, 0, '0', 1, 'sublet Female for a Roommates at Mirpur 12', 'sublet-female-for-a-roommates-at-mirpur-12', 0, 1, 'Dhaka', 1, 'Mirpur', 31, 2, 'Effat ara', NULL, '01675463792', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 20:53:28', 31, '2021-08-27 20:53:28', NULL, 4, '[\"2\"]', 0, NULL, 0, 0, 0, 0),
(51, 1047, 'roommate', 1, 'Apartment', 'mirpur 1', 'Ready', 1, '0', 0, 0, '0', 1, 'Independent Mess Male for a Roommates at Mirpur 1', 'independent-mess-male-for-a-roommates-at-mirpur-1', 0, 1, 'Dhaka', 1, 'Mirpur', 32, 2, 'minhaz', NULL, '01787658769', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 20:59:33', 32, '2021-08-27 20:59:33', NULL, 3, '[\"2\",\"3\"]', 0, NULL, 0, 0, 0, 0),
(52, 1048, 'rent', 2, 'Office', 'mirpur 1', 'Ready', 1, '0', 0, 0, '0', 1, 'সুদৃশ্য ডেকোরেশনসহ একটি আউটলেট অফিস ভাড়া দেওয়া হবে।', '-1048', 0, 1, 'Dhaka', 1, 'Mirpur', 33, 2, 'Kh Nazmul', NULL, '01523647392', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-27 21:10:15', 33, '2021-08-27 21:10:15', NULL, 3, 'null', 0, NULL, 0, 0, 0, 0),
(53, 1049, 'rent', 3, 'Shop', 'Mirpur 2', 'Used', 4, '0', 0, 0, '0', 1, '1000 sqft, Showroom/Shop/Restaurant for Rent at Mirpur 2', '1000-sqft-showroomshoprestaurant-for-rent-at-mirpur-2', 0, 1, 'Dhaka', 1, 'Mirpur', 34, 2, 'Md. Nurul Islam', NULL, '01978541254', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 04:45:25', 34, '2021-08-28 04:45:25', NULL, 1, '[\"1\"]', 0, NULL, 0, 0, 0, 0),
(54, 1050, 'rent', 1, 'Apartment', 'rampura', 'Used', 4, '0', 0, 0, '0', 1, '1800 sqft, 3 Beds Apartment/Flats for Rent at Rampura', '1800-sqft-3-beds-apartmentflats-for-rent-at-rampura', 0, 1, 'Dhaka', 10, 'Rampura', 35, 2, 'Rayyan Properties', NULL, '01821547896', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 04:55:31', 35, '2021-08-28 04:55:31', NULL, 6, '[\"4\"]', 0, NULL, 0, 0, 0, 0),
(55, 1051, 'rent', 1, 'Apartment', 'uttara', 'Ready', 1, '0', 0, 0, '0', 1, '1654 sqft, 3 Beds Apartment/Flats for Rent at Uttara', '1654-sqft-3-beds-apartmentflats-for-rent-at-uttara', 0, 1, 'Dhaka', 9, 'Uttara', 36, 2, 'Md. Riazul Islam', NULL, '01865239874', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 05:09:01', 36, '2021-08-28 05:09:01', NULL, 6, '[\"4\"]', 0, NULL, 0, 0, 0, 0),
(56, 1052, 'rent', 1, 'Apartment', 'Mirpur', 'Used', 4, '0', 0, 0, '0', 1, '1300 sqft, 3 Beds Apartment/Flats for Rent at Mirpur 12', '1300-sqft-3-beds-apartmentflats-for-rent-at-mirpur-12', 0, 1, 'Dhaka', 1, 'Mirpur', 37, 2, 'Md. Abu Zahid', NULL, '071785421365', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 05:31:29', 37, '2021-08-28 05:31:29', NULL, 6, '[\"4\"]', 0, NULL, 0, 0, 0, 0),
(57, 1053, 'rent', 1, 'Apartment', 'Basundhara', 'Ready', 1, '0', 0, 0, '0', 1, '2250 sqft, 4 Beds Flats for Rent at Bashundhara R/A', '2250-sqft-4-beds-flats-for-rent-at-bashundhara-ra', 0, 1, 'Dhaka', 12, 'Basundhara', 38, 2, 'kazi salimuddin', NULL, '01698547993', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 05:46:00', 38, '2021-08-28 05:46:00', NULL, 5, '[\"5\"]', 0, NULL, 0, 0, 0, 0),
(58, 1054, 'rent', 1, 'Apartment', 'Kathalbagan', 'Ready', 1, '0', 0, 0, '0', 1, '1250 sqft, 2 Beds Flats for Rent at Kathalbagan', '1250-sqft-2-beds-flats-for-rent-at-kathalbagan', 0, 1, 'Dhaka', 22, 'Kathalbagan', 39, 2, 'Dr. Fazle Rabbi', NULL, '01987541254', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 05:52:44', 39, '2021-08-28 05:52:44', NULL, 6, '[\"2\"]', 0, NULL, 0, 0, 0, 0),
(59, 1055, 'sell', 5, 'Industrial space', 'Gazipur Sadar', 'Ready', 1, '0', 0, 0, '0', 2, '20000 sqft, Ready Industrial Space for Sale at Gazipur Sadar', '20000-sqft-ready-industrial-space-for-sale-at-gazipur-sadar', 0, 5, 'Gazipur', 24, 'Gazipur Sadar', 40, 2, 'M.S. Rana', NULL, '01558745698', NULL, 1, 'General Listing for 30 days', NULL, NULL, NULL, NULL, 0, NULL, NULL, '2021-08-28 06:00:35', 40, '2021-08-28 06:00:35', NULL, 2, '[\"1\"]', 0, NULL, 0, 0, 0, 0);
...
(126, 58, '1250', 2, 2, 22000, 1),
(127, 59, '20000', 0, 0, 5000000, 1);
...
CREATE TABLE `SLS_LEAD_MANAGEMENTS` (
  `PK_NO` int(1) NOT NULL,
  `START_DATE` date DEFAULT NULL,
  `END_DATE` date DEFAULT NULL,
...
CREATE TABLE `SLS_LEAD_SEND` (
  ...
  `COMMENTS` longtext CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `SLS_POSTREQUIREMENTS` (
  `PK_NO` int(16) NOT NULL,
...
INSERT INTO `SS_AREA` (`PK_NO`, `AREA_NAME`, `URL_SLUG`, `F_CITY_NO`, `CITY_NAME`, `IS_ACTIVE`, `ORDER_ID`, `LAT`, `LON`) VALUES
(1, 'Mirpur', 'mirpur', 1, 'Dhaka', 1, 1, NULL, NULL),
(2, 'Banani', 'banani', 1, 'Dhaka', 1, 2, NULL, NULL),
(3, 'Mohakhali', 'mohakhali', 1, 'Dhaka', 1, 3, NULL, NULL),
(4, 'GOC', 'goc', 2, 'Chittagong', 1, 1, NULL, NULL),
(5, 'Mogbazar', 'mogbazar', 1, 'Dhaka', 1, 4, NULL, NULL),
(6, 'Mohammadpur', 'mohammadpur', 1, 'Dhaka', 1, 5, NULL, NULL),
(7, ' Banasree', 'banasree', 1, 'Dhaka', 1, 6, NULL, NULL),
(8, 'Eskaton', 'eskaton', 1, 'Dhaka', 1, 7, NULL, NULL),
(9, 'Uttara', 'uttara', 1, 'Dhaka', 1, 8, NULL, NULL),
(10, 'Rampura', 'rampura', 1, 'Dhaka', 1, 9, NULL, NULL),
(11, 'Mirbag', 'mirbag', 1, 'Dhaka', 1, 10, NULL, NULL),
(12, 'Basundhara', 'basundhara', 1, 'Dhaka', 1, 11, NULL, NULL),
(13, 'Naya Paltan', 'naya-paltan', 1, 'Dhaka', 1, 12, NULL, NULL),
(14, 'Adabor', 'adabor', 1, 'Dhaka', 1, 13, NULL, NULL),
(15, 'Narayanganj Sadar', 'narayanganj-sadar', 4, 'Narayanganj', 1, 1, NULL, NULL),
(16, 'Malibag', 'malibag', 1, 'Dhaka', 1, 14, NULL, NULL),
(17, 'Baridhara', 'baridhara', 1, 'Dhaka', 1, 15, NULL, NULL),
(18, 'Purbachal', 'purbachal', 1, 'Dhaka', 1, 16, NULL, NULL),
(19, 'Savar', 'savar', 1, 'Dhaka', 1, 17, NULL, NULL),
(20, 'Badda', 'badda', 1, 'Dhaka', 1, 18, NULL, NULL),
(21, 'Aftab Nagar', 'aftab-nagar', 1, 'Dhaka', 1, 19, NULL, NULL),
(22, 'Kathalbagan', 'kathalbagan', 1, 'Dhaka', 1, 20, NULL, NULL),
(23, 'Kathalbagan', 'kathalbagan', 1, 'Dhaka', 1, 21, NULL, NULL),
(24, 'Gazipur Sadar', 'gazipur-sadar', 5, 'Gazipur', 1, 1, NULL, NULL);
...
CREATE TABLE `WEB_NEWSLETTER` (
  `PK_NO` bigint(20) UNSIGNED NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='WEB_NOTIFICATION' ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `WEB_NOTIFICATION_DEVICE` (
  ...
  `CREATED_BY` int(4) DEFAULT NULL,
  `CREATED_ON` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='WEB_NOTIFICATION_DEVICE' ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='WEB_WHATSAPP' ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `WEB_USER` (
  ...
  `AUTO_PAYMENT_RENEW` int(1) NOT NULL DEFAULT 1 COMMENT 'Owner''s property will auto payment renew if his balance is available, ',
...
INSERT INTO `WEB_USER` (`PK_NO`, `CODE`, `NAME`, `DESIGNATION`, `EMAIL`, `MOBILE_NO`, `PASSWORD`, `GENDER`, `DOB`, `FACEBOOK_ID`, `GOOGLE_ID`, `PROFILE_PIC`, `PROFILE_PIC_URL`, `ACTIVATION_CODE`, `ACTIVATION_CODE_EXPIRE`, `IS_FIRST_LOGIN`, `USER_TYPE`, `CAN_LOGIN`, `REMEMBER_TOKEN`, `STATUS`, `CREATED_BY`, `UPDATED_BY`, `CREATED_AT`, `UPDATED_AT`, `IS_EMAIL_VERIFIED`, `IS_MOBILE_VERIFIED`, `EMAIL_VERIFY_CODE`, `EMAIL_VERIFY_EXPIRE`, `MOBILE_VERITY_CODE`, `MOBILE_VERIFY_EXPIRE`, `CONTACT_PER_NAME`, `ADDRESS`, `ACTUAL_TOPUP`, `PENDING_TOPUP`, `USED_TOPUP`, `UNUSED_TOPUP`, `TOTAL_LISTING`, `LISTING_LIMIT`, `TOTAL_LEAD`, `AUTO_PAYMENT_RENEW`, `IS_FEATURE`) VALUES
(13, 1000, 'maidul1', NULL, 'owner@gmail.com', '123456', '$2y$10$WAp/98uhcPn2e06RQCf3KuCX9wFSwds/Oz/yJklaiStsYB5R882b.', 1, NULL, NULL, NULL, '60b13784f3288.jpg', '/uploads/user/13/60b13784f3288.jpg', NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-04-11 20:33:09', '2021-07-28 18:01:15', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 4, 5, 0, 1, 0),
(14, 1001, 'Maidul Islam Babu', NULL, 'seeker@gmail.com', '01681944126', '$2y$10$uDfNvGFGnLQoltKrDaAuk.bipD33SYs.AWxvL3D2UyeahDBGwaCvy', 1, NULL, NULL, NULL, '60b11641916e1.jpg', '/uploads/user/14/60b11641916e1.jpg', NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-04-14 10:00:54', '2021-07-29 17:32:18', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1000, 0, 5, 0, 1, 0),
(15, 1002, 'Maidul Islam Babu', NULL, 'developer@gmail.com', '01681944127', '$2y$10$WAp/98uhcPn2e06RQCf3KuCX9wFSwds/Oz/yJklaiStsYB5R882b.', 1, NULL, NULL, NULL, '60b11641916e1.jpg', '/uploads/user/14/60b11641916e1.jpg', NULL, NULL, 1, 3, 1, NULL, 1, 0, 0, '2021-04-14 10:00:54', '2021-05-28 16:16:40', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1295, 2, 2, 0, 1, 0),
(16, 1003, 'Monowar Hossain Khan', 'Donno', 'agency@gmail.com', '01700000006', '$2y$10$uvycUE.pzSq/WKN/cxFdWeIwDrWlji8U.Sqs3gvWvygud3QNOGN76', 1, NULL, NULL, NULL, '610aace6e3724.jpeg', '/uploads/user/16/610aace6e3724.jpeg', NULL, NULL, 1, 4, 1, NULL, 1, 0, 2, '2021-08-04 07:22:48', '2021-08-26 01:07:46', 0, 0, NULL, NULL, NULL, NULL, 'Sazol Khan', 'Tongi', 0, 0, 0, 500, 4, 5, 0, 1, 0),
(17, 1004, 'Sazol Khan', 'Agent', 'agent@gmail.com', '01700000000', '$2y$10$MuWw/4agzfMUrr.2sqatCu77Dxv5F57kwjkPVPKGKOupjSj3zTgwi', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 5, 1, NULL, 1, 0, 0, '2021-08-04 19:15:24', '2021-08-04 19:15:24', 0, 0, NULL, NULL, NULL, NULL, NULL, 'Janata Road', 0, 0, 0, 0, 2, 5, 0, 1, 0),
(18, 1005, 'Maidul Islam', NULL, 'maidul@gmail.com', NULL, '$2y$10$ecx6SE11Em32.OBM99BwdO7/iZIl0hwwjl0v/WkIuxJGLcH28i/eS', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-05 20:38:54', '2021-08-05 20:49:08', 0, 0, NULL, NULL, NULL, NULL, 'Anawar', NULL, 0, 0, 0, 100, 0, 5, 0, 1, 0),
...
(20, 1007, 'Md Monowar', NULL, 'monowar@gmail.com', '01681944128', '$2y$10$FW8ofpMXZSL6eetYq39LXeJrkF/W6tpab2Re3/vDaN1Fo3hL84vn6', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-17 18:56:16', '2021-08-17 18:56:16', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 5, 0, 1, 0),
(21, 1008, 'IMAGINE PROPERTIES LTD.', 'Builder', 'imaginep@gmail.com', '01939919000', '$2y$10$origRanuRU96nGVUMeyhuusu2uAul.M2EiKwvqoiEfdzwgDBKhefq', 1, NULL, NULL, NULL, '6127bf3da3586.jpg', '/uploads/user/21/6127bf3da3586.jpg', NULL, NULL, 1, 3, 1, NULL, 1, 0, 2, '2021-08-26 16:19:19', '2021-08-26 22:52:15', 0, 0, NULL, NULL, NULL, NULL, 'IMAGINE PROPERTIES LTD.', 'House 71, Road No.: 27, Gulshan - 1, Dhaka - 1212', 0, 0, 0, 0, 4, 10, 0, 1, 0),
(22, 1009, 'LUCKY ENGINEERING LIMITED', 'Builder', 'luckye@gmail.com', '01312131458', '$2y$10$B1/JDEWu/YmbhhUB3yHeR.fU/Z6S0FCjK5qgqDtxx9LW3vCEiZkzu', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 3, 1, NULL, 1, 0, 2, '2021-08-26 17:19:32', '2021-08-26 23:25:11', 0, 0, NULL, NULL, NULL, NULL, 'LUCKY ENGINEERING LIMITED', 'Dhaka', 0, 0, 0, 0, 9, 10, 0, 1, 0),
(23, 1010, 'Rafiqul Islam Ratul', NULL, 'rafiqul@gmail.com', '01709659000', '$2y$10$RMslr5bNLcBZcS50ciUGUejel7Ck9rF9NYZLFISkL21m8YNKwdTYC', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-26 20:46:22', '2021-08-26 20:46:22', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(24, 1011, 'RAYYAN PROPERTIES', 'Buuilder', 'rayyan@gmail.com', '01300773000', '$2y$10$8Nq9Tu24MFjGGPoLJe3LLOw4jbSVVFVr25TmADp3KNg2NMwOzonMy', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 3, 1, NULL, 1, 0, 2, '2021-08-26 20:52:01', '2021-08-27 02:53:17', 0, 0, NULL, NULL, NULL, NULL, 'RAYYAN PROPERTIES', 'Basundhara', 0, 0, 0, 0, 4, 10, 0, 1, 0),
(25, 1012, 'Purbachal Marine City', NULL, 'purbachalmarinecity@gmail.com', '01345217032', '$2y$10$./A.yFT0s/6Ns3HMy1H.Q.TGKDRYUcro5AxROndPQaUitjIv9HLNm', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 3, 1, NULL, 1, 0, 0, '2021-08-27 17:50:05', '2021-08-27 17:50:05', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 3, 10, 0, 1, 0),
(26, 1013, 'Dhanshiri Residence', 'Owner', 'dhanshiriresidensial@gmail.com', '01923847564', '$2y$10$MgKpU.PSuOiBAWE0EksIEOplUcDenCEOzQ7DUkvm982siBeqA8Ta.', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 3, 1, NULL, 1, 0, 0, '2021-08-27 19:17:22', '2021-08-27 19:17:22', 0, 0, NULL, NULL, NULL, NULL, 'Rifat Al Islam', 'Savar, Dhaka', 0, 0, 0, 0, 7, 10, 0, 1, 0),
(27, 1014, 'Richmond Developers Ltd.', 'Manager', 'richmonddevltd@gmail.com', '01484773892', '$2y$10$CxGcTvpmiEy4Yj5MkfmWcOm/P4A4Pb2G.wxxb8fdi4Xzfu21ppaaG', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 3, 1, NULL, 1, 0, 0, '2021-08-27 19:53:30', '2021-08-27 19:53:30', 0, 0, NULL, NULL, NULL, NULL, 'Tarikul Islam', 'Narayangonj Sadar, Narayanganj', 0, 0, 0, 0, 2, 10, 0, 1, 0),
(28, 1015, 'ismail munna', NULL, 'ismailmunna@gmail.com', '01708042445', '$2y$10$grZBJhpmvN0M2DIjnOySn.DvLplNgmBAA/xr73s2l8aM5PFGkxir.', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-27 20:14:26', '2021-08-27 20:14:26', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(29, 1016, 'anur mia', NULL, 'anurmia@yahoo.com', '01928374854', '$2y$10$Pf24Y.7u7ETrHkuo.vbWFeVHkOTF1ZMicm3DWY79dyMdIVtFJyjfu', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-27 20:23:33', '2021-08-27 20:23:33', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(30, 1017, 'Shah', NULL, 'shahalam232@gmail.com', '01982737464', '$2y$10$ZGStQx0gfnJIjuAIgwxyteM9OrwkkuXVeOBxdgKweiABLsJHnpK9O', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-27 20:34:32', '2021-08-27 20:34:32', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(31, 1018, 'Effat Ara', NULL, 'effat234ara@gmail.com', '01675463792', '$2y$10$iIafRkxMKHAaqfHuAtc2HO2DLrCaU9EqeN94/5LTk7UMFVUY0FRGK', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-27 20:47:11', '2021-08-27 20:47:11', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(32, 1019, 'Minhaz', NULL, 'minhaz67263@gmail.com', '01387654354', '$2y$10$xEhHC3NRuOfqUMVPHJjXm.9Xt8bJmzEUN1OoPPareq.B/rUOLdAQO', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-27 20:56:49', '2021-08-27 20:56:49', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(33, 1020, 'Kh Nazmul', NULL, 'khnazmul@gmail.com', '01523647392', '$2y$10$XxQ6.sMswGHOuXNBGZfSKuT.k9YWynhtIQMON2j9oIeKEcyZkg382', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-27 21:03:10', '2021-08-27 21:03:10', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(34, 1021, 'Md. Nurul Islam', NULL, 'nurulislam453@gmail.com', '01978541254', '$2y$10$w9RA4HLX0s77BXW9oNmDDOLcNPGU7BsxirGIj0sUGsAabHJHELdLG', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-28 04:40:41', '2021-08-28 04:40:41', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(35, 1022, 'Rayyan Properties', NULL, 'rayyanprop@gmail.com', '01821547896', '$2y$10$7yOilca8cnBy5nq31PFXHuqBXns18dHMPrSdvS/mA8uSr1kj7ZnL6', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-28 04:50:22', '2021-08-28 04:50:22', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(36, 1023, 'Md. Riazul Islam', NULL, 'riazulislam@gmail.com', '01865239874', '$2y$10$/p9ThOdUVIMk.FyyW0iQsuDuCi7lv7bt.BE4.677hLN9to01hqSiu', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, NULL, 1, 0, 0, '2021-08-28 05:05:35', '2021-08-28 05:05:35', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(37, 1024, 'Md. Abu Zahid', NULL, 'mdabuzahid902@gmail.com', '071785421365', '$2y$10$eMIci4Hct1KR9M8zMdCFZ.c8i3NItkhVsDGegQNqp2VFowphCs0Ne', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-28 05:21:47', '2021-08-28 05:21:47', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(38, 1025, 'kazi salimuddin', NULL, 'kazisalimuddin245@gmail.com', '01698547993', '$2y$10$RgF1/b31oSSj55/D5F3aK.LUNFrp/GuuiV51ZE693MU/H5R6jWlSC', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-28 05:42:57', '2021-08-28 05:42:57', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(39, 1026, 'Dr. Fazle Rabbi', NULL, 'fazlerabbi34@yahoo.com', '01987541254', '$2y$10$yEGcHZKpYykom0CkWp0qZeLXDGJffbSyYqMINbt95ALaeNZ.i3HQe', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-28 05:47:45', '2021-08-28 05:47:45', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0),
(40, 1027, 'M.S. Rana', NULL, 'ranams34@yahoo.com', '01558745698', '$2y$10$iDHPf2rjACWpSctKgMHIge7cNOpP1wPIYgNkpVdwc8kO8QMe4g9D.', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, NULL, 1, 0, 0, '2021-08-28 05:55:11', '2021-08-28 05:55:11', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 1, 0, 1, 0);
...
(2, 15, NULL, NULL, NULL, NULL, NULL, NULL, '02:17', '14:18', '[\"0\",\"1\",\"2\",\"4\",\"5\"]'),
...
--
-- Indexes for table `ACC_BANK_TXN`
--
ALTER TABLE `ACC_BANK_TXN`
...
--
-- Indexes for table `ACC_CUSTOMER_PAYMENT_USED`
--
ALTER TABLE `ACC_CUSTOMER_PAYMENT_USED`
  ADD PRIMARY KEY (`PK_NO`);
...
--
-- Indexes for table `SLS_LEAD_MANAGEMENTS`
--
ALTER TABLE `SLS_LEAD_MANAGEMENTS`
  ADD PRIMARY KEY (`PK_NO`);

--
-- Indexes for table `SLS_LEAD_MASTER`
--
ALTER TABLE `SLS_LEAD_MASTER`
  ADD PRIMARY KEY (`PK_NO`);

--
-- Indexes for table `SLS_LEAD_SEND`
--
ALTER TABLE `SLS_LEAD_SEND`
  ADD PRIMARY KEY (`PK_NO`);

--
-- Indexes for table `SLS_POSTREQUIREMENTS`
--
ALTER TABLE `SLS_POSTREQUIREMENTS`
  ADD PRIMARY KEY (`PK_NO`);
...
ALTER TABLE `SS_CURRENCY`
  ...
  ADD UNIQUE KEY `U_SS_CURRENCY_N` (`NAME`);
...
--
-- Indexes for table `SS_STICKY_NOTE`
--
ALTER TABLE `SS_STICKY_NOTE`
  ADD PRIMARY KEY (`PK_NO`);
...
--
-- Indexes for table `WEB_ARTICLE_CATEGORY`
--
...
--
-- Indexes for table `WEB_COMPARE`
--
ALTER TABLE `WEB_COMPARE`
  ADD PRIMARY KEY (`PK_NO`);
...
--
-- Indexes for table `WEB_NEWSLETTER`
--
ALTER TABLE `WEB_NEWSLETTER`
  ADD PRIMARY KEY (`PK_NO`);
...
--
-- Indexes for table `WEB_NOTIFICATION_DEVICE`
--
ALTER TABLE `WEB_NOTIFICATION_DEVICE`
  ADD PRIMARY KEY (`PK_NO`),
...
--
-- Indexes for table `WEB_PRD_REVIEWS`
--
ALTER TABLE `WEB_PRD_REVIEWS`
  ADD PRIMARY KEY (`PK_NO`);
...
--
-- Indexes for table `WEB_WHATSAPP`
--
ALTER TABLE `WEB_WHATSAPP`
  ADD PRIMARY KEY (`PK_NO`);

--
-- Indexes for table `WEB_WISHLIST`
--
ALTER TABLE `WEB_WISHLIST`
  ADD PRIMARY KEY (`PK_NO`);
...
--
-- AUTO_INCREMENT for table `ACC_BANK_TXN`
--
ALTER TABLE `ACC_BANK_TXN`
...
--
-- AUTO_INCREMENT for table `ACC_CUSTOMER_PAYMENT_USED`
--
ALTER TABLE `ACC_CUSTOMER_PAYMENT_USED`
...
--
ALTER TABLE `PRD_FLOOR_LIST`
  MODIFY `PK_NO` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `PRD_LISTINGS`
--
ALTER TABLE `PRD_LISTINGS`
  MODIFY `PK_NO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `PRD_LISTING_IMAGES`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `PRD_LISTING_VARIANTS`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
...
--
ALTER TABLE `PRD_PROPERTY_CONDITION`
  MODIFY `PK_NO` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `PRD_PROPERTY_TYPE`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `PRD_REQUIREMENTS`
--
ALTER TABLE `PRD_REQUIREMENTS`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT for table `SLS_LEAD_MANAGEMENTS`
--
ALTER TABLE `SLS_LEAD_MANAGEMENTS`
  MODIFY `PK_NO` int(1) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `SLS_LEAD_MASTER`
--
ALTER TABLE `SLS_LEAD_MASTER`
  MODIFY `PK_NO` int(1) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `SLS_LEAD_SEND`
--
ALTER TABLE `SLS_LEAD_SEND`
  MODIFY `PK_NO` int(1) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `SLS_POSTREQUIREMENTS`
--
ALTER TABLE `SLS_POSTREQUIREMENTS`
  MODIFY `PK_NO` int(16) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `SS_AREA`
--
ALTER TABLE `SS_AREA`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `SS_LISTING_PRICE`
  MODIFY `PK_NO` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `SS_STICKY_NOTE`
--
ALTER TABLE `SS_STICKY_NOTE`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `WEB_ABOUT`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `WEB_ARTICLE`
--
ALTER TABLE `WEB_ARTICLE`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT for table `WEB_ARTICLE_CATEGORY`
--
ALTER TABLE `WEB_ARTICLE_CATEGORY`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `WEB_CART`
--
ALTER TABLE `WEB_CART`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=628;

--
-- AUTO_INCREMENT for table `WEB_COMPARE`
--
ALTER TABLE `WEB_COMPARE`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `WEB_FAQ`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `WEB_NEWSLETTER`
--
ALTER TABLE `WEB_NEWSLETTER`
  MODIFY `PK_NO` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `WEB_NOTIFICATION`
--
ALTER TABLE `WEB_NOTIFICATION`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT for table `WEB_NOTIFICATION_DEVICE`
--
ALTER TABLE `WEB_NOTIFICATION_DEVICE`
...
--
ALTER TABLE `WEB_PAGES`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
-- AUTO_INCREMENT for table `WEB_PRD_REVIEWS`
--
ALTER TABLE `WEB_PRD_REVIEWS`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
-- AUTO_INCREMENT for table `WEB_WHATSAPP`
--
ALTER TABLE `WEB_WHATSAPP`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `WEB_WISHLIST`
--
ALTER TABLE `WEB_WISHLIST`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
