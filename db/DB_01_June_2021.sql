...
CREATE TABLE `WEB_CONFIG` (
  ...
  `FAV_PATH` varchar(255) DEFAULT NULL,
...
INSERT INTO `WEB_CONFIG` (`PK_NO`, `META_TITLE`, `META_KEYWORDS`, `META_DESC`, `LOGO_PATH`, `FAV_PATH`, `CREATED_BY`, `UPDATED_BY`, `CREATED_AT`, `UPDATED_AT`) VALUES
(1, 'AD', 'ADSD', 'ADASDASD', '/media/images/banner/prod_01062021_60b54720ac188.png', '/media/images/banner/prod_01062021_60b54720a852d.png', NULL, NULL, NULL, NULL);
...
ALTER TABLE `ACC_CUSTOMER_PAYMENTS`
  ...
  ADD KEY `FK_ACC_CUSTOMER_PAYMENTS_SS_CURRENCY` (`F_PAYMENT_CURRENCY_NO`);
...
--
ALTER TABLE `PRD_LISTINGS`
  MODIFY `PK_NO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `PRD_LISTING_VARIANTS`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
