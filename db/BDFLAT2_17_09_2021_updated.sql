...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2021 at 11:28 PM
...
(10, 15, 6, 3, '2021-09-17 02:16:25', 0),
(11, 15, 14, 1, '2021-09-17 02:34:24', 0),
(12, 17, 14, 1, '2021-09-17 02:35:54', 0);
...
CREATE TABLE `PRD_LEAD_SHARE_MAP` (
  `PK_NO` int(10) NOT NULL,
...
(80, 1, 79, 'South Facing', '2021-09-14 00:00:00', '<p>1400 sqft, 3 Beds Ready Apartment/Flats for Sale at Akhalia</p>', '[\"1\"]', NULL, '[\"1\"]', NULL, NULL, NULL),
...
(184, 6, '/uploads/listings/6/6143a5f6de92a.jpg', '6143a5f6de92a.jpg', '/uploads/listings/6/thumb/6143a5f6de933.jpg', '6143a5f6de933.jpg', 1),
(185, 6, '/uploads/listings/6/6143a5f7239db.jpg', '6143a5f7239db.jpg', '/uploads/listings/6/thumb/6143a5f7239e2.jpg', '6143a5f7239e2.jpg', 0),
(186, 14, '/uploads/listings/14/6143aa8635c5c.jpg', '6143aa8635c5c.jpg', '/uploads/listings/14/thumb/6143aa8635c66.jpg', '6143aa8635c66.jpg', 1);
...
(282, 5, '1690', 3, 3, 3700, 1),
(283, 8, '1800', 3, 3, 30000, 1),
(284, 6, '1478', 3, 3, 3000, 1),
(285, 14, '250', 1, 1, 4999, 1);
...
(1, 'Apartment', 'apartment', 1, 1, 'A', 'Apartment', 'Apartment', NULL, NULL, NULL, '/media/images/property-category/img_21082021_6121388ceb546.png', '2021-06-01 19:28:13', NULL, 2, '2021-08-21 23:31:56', 42),
...
(7, 20, 1, 'Dhaka', '[\"2\",\"3\",\"5\"]', NULL, 'sale', 2, 'Office', 800, 1800, 2000000, 3000000, '[\"any\"]', '[\"1\"]', '[\"ready\"]', '<p>I need a perfect property&nbsp;</p>', '01:00:00', 'daily', NULL, 20, '2021-09-10 22:09:11', 20, 0, 1, NULL, NULL, 0, 0),
...
(10, 41, 1, 'Dhaka', '[\"1\",\"5\"]', NULL, 'sale', 2, 'Office', 100, 1000, 10, 100, '[\"1bed\",\"2bed\"]', '[2,1]', '[\"Semi Ready\",\"Ready\"]', '<p>test</p>', '04:10:00', 'daily', NULL, 41, '2021-09-13 01:39:14', 2, 1, 1, 2, '2021-09-13 01:39:14', 0, 0),
...
(26, 34, 1, 'Dhaka', '[\"14\",\"29\"]', NULL, 'rent', 5, 'Industrial space', 1250, 5000, 270000, 1000000, '[\"3bed\",\"4plus\"]', '[4,3,1]', '[\"Used\",\"Ongoing\",\"Ready\"]', '<p>Industrial Space</p>', '03:00:00', 'weekly', '2021-09-13 01:51:21', 2, '2021-09-13 01:51:21', 2, 0, 1, NULL, NULL, 10, 0),
...
(43, 80, 1, 'Dhaka', '[\"1\",\"2\"]', NULL, 'rent', 1, 'Apartment', 1500, 2400, 150000, 150000, '[\"any\"]', '[4,1]', '[\"Used\",\"Ready\"]', '<p>Apartment</p>', '12:43:00', 'weekly', '2021-09-15 00:43:43', 2, '2021-09-15 00:43:43', 2, 1, 1, 2, '2021-09-15 00:43:43', 58, 0),
...
CREATE TABLE `PRD_SUGGESTED_PROPERTY` (
  `PK_NO` int(10) NOT NULL,
  `F_LISTING_NO` int(11) DEFAULT NULL,
  `F_COMPANY_NO` int(11) DEFAULT NULL COMMENT '	FROM WEB_USERS WHO IS BUILDER',
...
CREATE TABLE `PRD_SUGGESTED_PROPERTY_TEMP` (
  `PK_NO` int(10) NOT NULL,
  `F_LISTING_NO` int(11) DEFAULT NULL,
  `F_COMPANY_NO` int(11) DEFAULT NULL COMMENT '	FROM WEB_USERS WHO IS BUILDER',
  `F_USER_NO` int(10) DEFAULT NULL COMMENT 'SEEKER PK_NO FROM WEB_USERS',
...
(1, 'Dhaka', 'dhaka', 1, 1, 19, NULL, NULL, 1, 82),
...
(15, 1002, 'Maidul Islam Babu', 'Data analyst', 'developer@gmail.com', '01681944127', '$2y$10$WAp/98uhcPn2e06RQCf3KuCX9wFSwds/Oz/yJklaiStsYB5R882b.', 1, NULL, NULL, NULL, '60b11641916e1.jpg', '/uploads/user/14/60b11641916e1.jpg', NULL, NULL, 1, 3, 1, NULL, 1, 0, 2, '2021-04-14 10:00:54', '2021-09-02 22:11:30', 0, 0, NULL, NULL, NULL, NULL, 'Maidul Islam Babu', 'mirur', 2000, 0, 0, 1900, 2, 20, 0, 0, 1),
...
(17, 1004, 'Sazol Khan', 'Agent', 'agent@gmail.com', '01700000000', '$2y$10$MuWw/4agzfMUrr.2sqatCu77Dxv5F57kwjkPVPKGKOupjSj3zTgwi', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 5, 1, NULL, 1, 0, 0, '2021-08-04 19:15:24', '2021-08-04 19:15:24', 0, 0, NULL, NULL, NULL, NULL, NULL, 'Janata Road', 0, 0, 0, 0, 3, 5, 0, 0, 1),
...
(65, 1052, 'RUMANA PROPERTIES LTD', 'Agency', 'rumanaltd@gmail.com', '01792090000', '$2y$10$R.6pCJRE/A0xi7a.L95fROSSzu7yaWkIrBZNlasdh3tTftenZJXgq', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 4, 1, NULL, 1, 0, 2, '2021-09-14 21:11:40', '2021-09-14 21:13:49', 0, 0, NULL, NULL, NULL, NULL, 'RUMANA PROPERTIES LTD', 'Dhaka', 1000, 0, 0, 940, 2, 10, 0, 0, 1),
...
ALTER TABLE `ACC_LISTING_LEAD_PAYMENTS`
  ADD PRIMARY KEY (`PK_NO`),
  ADD UNIQUE KEY `U_LISTING_NO_USER_NO` (`PK_NO`);
...
--
-- Indexes for table `PRD_LEAD_SHARE_MAP`
--
ALTER TABLE `PRD_LEAD_SHARE_MAP`
  ADD PRIMARY KEY (`PK_NO`),
  ADD UNIQUE KEY `u_prd_lead_share_map` (`F_REQUIREMENT_NO`,`F_COMPANY_NO`);
...
--
-- Indexes for table `PRD_SUGGESTED_PROPERTY`
--
ALTER TABLE `PRD_SUGGESTED_PROPERTY`
  ADD PRIMARY KEY (`PK_NO`);

--
-- Indexes for table `PRD_SUGGESTED_PROPERTY_TEMP`
--
ALTER TABLE `PRD_SUGGESTED_PROPERTY_TEMP`
  ADD PRIMARY KEY (`PK_NO`);
...
--
ALTER TABLE `ACC_CUSTOMER_PAYMENTS`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `ACC_CUSTOMER_TRANSACTION`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
...
--
ALTER TABLE `ACC_LISTING_PAYMENTS`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
-- AUTO_INCREMENT for table `PRD_LEAD_SHARE_MAP`
--
ALTER TABLE `PRD_LEAD_SHARE_MAP`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `PRD_LISTINGS`
  MODIFY `PK_NO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT for table `PRD_LISTINGS_SEO`
--
ALTER TABLE `PRD_LISTINGS_SEO`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `PRD_LISTING_ADDITIONAL_INFO`
--
ALTER TABLE `PRD_LISTING_ADDITIONAL_INFO`
  MODIFY `PK_NO` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `PRD_LISTING_IMAGES`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
...
--
ALTER TABLE `PRD_LISTING_VARIANTS`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;

--
-- AUTO_INCREMENT for table `PRD_LISTING_VIEW`
--
ALTER TABLE `PRD_LISTING_VIEW`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
...
--
ALTER TABLE `PRD_REQUIREMENTS`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `PRD_SUGGESTED_PROPERTY`
--
ALTER TABLE `PRD_SUGGESTED_PROPERTY`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `PRD_SUGGESTED_PROPERTY_TEMP`
--
ALTER TABLE `PRD_SUGGESTED_PROPERTY_TEMP`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `SS_AREA`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `WEB_USER`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
