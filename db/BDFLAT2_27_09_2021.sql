...
CREATE TABLE IF NOT EXISTS `ACC_LEAD_PAYMENTS` (
  ...
  `F_LEAD_SHARE_NO` int(11) DEFAULT NULL,
  `F_REQUIREMENT_NO` int(11) DEFAULT NULL,
...
INSERT INTO ACC_CUSTOMER_TRANSACTION 
(CODE, F_CUSTOMER_NO, F_LEAD_PAYMENT_NO, AMOUNT, TRANSACTION_DATE, TRANSACTION_TYPE, IN_OUT, F_SS_CREATED_BY, SS_CREATED_ON, F_SS_MODIFIED_BY, SS_MODIFIED_ON) 
VALUES (VAR_CODE, NEW.F_COMPANY_NO, NEW.PK_NO, -NEW.AMOUNT, NEW.PURCHASE_DATE, '5', '2', NEW.CREATED_BY, NOW(), NEW.MODIFIED_BY, NOW());


SELECT IFNULL(SUM(AMOUNT),0) INTO VAR_AMOUNT FROM ACC_CUSTOMER_TRANSACTION WHERE F_CUSTOMER_NO = NEW.F_COMPANY_NO;

UPDATE WEB_USER SET UNUSED_TOPUP = VAR_AMOUNT WHERE PK_NO = NEW.F_COMPANY_NO;
...
UPDATE WEB_USER SET UNUSED_TOPUP = VAR_AMOUNT WHERE PK_NO = VAR_OWNER_NO;
...
--
-- Table structure for table `ACC_MOBILE_NO`
--

DROP TABLE IF EXISTS `ACC_MOBILE_NO`;
CREATE TABLE IF NOT EXISTS `ACC_MOBILE_NO` (
  `PK_NO` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `ACC_MOBILE_NO`
--

INSERT INTO `ACC_MOBILE_NO` (`PK_NO`, `F_PAYMENT_METHOD_NO`, `MOBILE_NO`, `IS_ACTIVE`) VALUES
(1, 2, '01721457854', 1),
(2, 2, '01354124785', 1),
(3, 3, '01821457854', 1),
(4, 3, '01987454124', 1);
...
INSERT INTO `ACC_RECHARGE_REQUEST` (`PK_NO`, `CODE`, `F_CUSTOMER_NO`, `CUSTOMER_NO`, `CUSTOMER_NAME`, `AMOUNT`, `F_ACC_PAYMENT_METHOD_NO`, `F_MOBILE_NO`, `MOBILE_NO`, `STATUS`, `ATTACHMENT_PATH`, `PAYMENT_NOTE`, `SLIP_NUMBER`, `PAYMENT_DATE`, `IS_ACTIVE`, `F_SS_CREATED_BY`, `SS_CREATED_ON`, `F_SS_MODIFIED_BY`, `SS_MODIFIED_ON`) VALUES
(1, NULL, 13, NULL, NULL, 50, 2, 1, NULL, 1, NULL, 'test', '1235fff', '2021-09-26', 1, NULL, NULL, NULL, NULL);
...
DECLARE VAR_CODE INT(10) DEFAULT 0;
DECLARE VAR_CUSTOMER_NAME VARCHAR(50) DEFAULT 0;
DECLARE VAR_CUSTOMER_NO INT(10) DEFAULT 0;
DECLARE VAR_MOBILE_NO VARCHAR(20) DEFAULT 0;

SELECT IFNULL(MAX(CODE),100) INTO VAR_CODE FROM ACC_CUSTOMER_REFUND;
SELECT NAME, CODE INTO VAR_CUSTOMER_NAME, VAR_CUSTOMER_NO from WEB_USER where PK_NO = NEW.F_CUSTOMER_NO;
SELECT MOBILE_NO INTO VAR_MOBILE_NO from ACC_MOBILE_NO where PK_NO = NEW.F_MOBILE_NO;
...
INSERT INTO `PRD_LEAD_SHARE_MAP` (`PK_NO`, `CODE`, `F_REQUIREMENT_NO`, `F_USER_NO`, `CREATED_AT`, `CREATED_BY`, `MODIFYED_AT`, `MODIFYED_BY`, `F_COMPANY_NO`, `F_LISTING_NO`, `PROPERTY_FOR`, `PROPERTY_TYPE`, `AREA`, `SIZE`, `PROPERTY_CONDITION`, `STATUS`, `ORDER_ID`, `LEAD_TYPE`) VALUES
(7, 1001, 10, 41, '2021-09-21 00:57:29', 2, NULL, NULL, 13, 15, 0, 0, 0, 0, 0, 0, 1, 0),
(8, 1002, 10, 41, '2021-09-21 00:57:29', 2, NULL, NULL, 21, 19, 0, 0, 0, 0, 0, 0, 2, 0),
(9, 1003, 10, 41, '2021-09-21 00:57:29', 2, NULL, NULL, 22, 28, 0, 0, 0, 0, 0, 0, 3, 0),
(11, 1004, 10, 41, '2021-09-21 00:57:29', 2, NULL, NULL, 24, 33, 0, 0, 0, 0, 0, 0, 5, 0),
(12, 1005, 10, 41, '2021-09-21 00:57:29', 2, NULL, NULL, 27, 46, 0, 0, 0, 0, 0, 0, 6, 0),
(13, 1006, 10, 41, '2021-09-21 00:57:29', 2, NULL, NULL, 58, 86, 0, 0, 0, 0, 0, 0, 7, 0);
...
SELECT IFNULL(MAX(CODE),1000) INTO VAR_CODE FROM PRD_LEAD_SHARE_MAP;
