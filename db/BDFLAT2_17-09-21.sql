...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2021 at 08:25 PM
...
--
ALTER TABLE `PRD_LISTING_IMAGES`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;
...
--
ALTER TABLE `PRD_LISTING_VARIANTS`
  MODIFY `PK_NO` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;

--
-- AUTO_INCREMENT for table `PRD_LISTING_VIEW`
--
ALTER TABLE `PRD_LISTING_VIEW`
  MODIFY `PK_NO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
