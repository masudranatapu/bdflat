...
<div class="row no-gutters form-group size_child" style="position: relative">
    <div class="col-6 col-md-1 size_div">
    ...
    <div class="col-6 col-md-2 bedroom_div" style="{{ $request->property_type != 1 ? 'display:none' : '' }}">
    ...
    <div class="col-6 col-md-2 bathroom_div" style="{{ $request->property_type != 1 ? 'display:none' : '' }}">
    ...
    <div class="col-6 col-md-2 bathroom_div">
    ...
    <div class="col-6 col-md-1 price_div">
