                            ...
                            <div class="new-property">
                                ...
                                @if(isset($data['properties']) && count($data['properties']))
                                    @foreach($data['properties'] as $property)
                                        @php
                                            $listing_variants = \App\Models\ListingVariants::where('F_LISTING_NO',$property->PK_NO)->get();
                                        @endphp
                                                ...
                                                <div class="col-8 position-static">
                                                    ...
                                                    <h6>
                                                        ...
                                                        @if($listing_variants->count() > 1 )
                                                            <a href="javascript:void(0)" data-id="{{$property->PK_NO}}" class="moreVariantBtn">More </a>
                                                        @endif
                                                    </h6>
