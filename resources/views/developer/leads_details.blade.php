            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="login-wrap text-center">
                        @auth
                            {!! Form::open([ 'route' => ['developer.lead.pay',$data['row']->PK_NO], 'method' => 'post', 'id'=>'login_user', 'class' => 'form-horizontal', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}

                            {!! Form::hidden('f_lead_share_no',$data['row']->PK_NO) !!}
