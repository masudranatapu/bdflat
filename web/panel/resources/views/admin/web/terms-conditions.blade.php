...
@section('title') @lang('web_setting.terms_condition_title') @endsection
@section('page-name') @lang('web_setting.terms_condition_title') @endsection
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="package">Terms & Conditions</label>
