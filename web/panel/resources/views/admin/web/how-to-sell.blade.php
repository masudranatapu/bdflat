...
@section('title') @lang('web_setting.howto_sell_title') @endsection
@section('page-name') @lang('web_setting.howto_sell_title') @endsection

@section('breadcrumb')
<li class="breadcrumb-item"><a href="#">@lang('admin_role.breadcrumb_title')  </a></li>
<li class="breadcrumb-item active">@lang('web_setting.howto_sell_title')    </li>
@endsection
