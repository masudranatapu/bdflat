                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {!! $errors->has('sub_category') ? 'error' : '' !!}">
                            ...
                            <div class="controls">
                                {!! Form::select('sub_category', $subcategory_combo, $row->scat_pk_no, ['class'=>'form-control mb-1 select2', 'id' => 'sub_category',  'placeholder' => 'Select subcategory', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1, 'id' => 'sub_category', 'data-url' => URL::to('get_brand')  ]) !!}
