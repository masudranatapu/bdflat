<div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>">
            <!-- <img class="brand-logo" alt="modern admin logo" src="<?php echo e(asset('/app-assets/images/logo/logo-light-is-logo.png')); ?>"> -->
                <h3 class="brand-text">bdflats.com</h3>
            </a></li>
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item" style="position: absolute;right:0px;">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">John Doe</span><span class="avatar avatar-online"><img src="<?php echo e(asset('/app-assets/images/portrait/small/avatar-s-19.png')); ?>" alt="avatar"><i></i></span>
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo e(route('logout')); ?>"><i class="ft-power"></i>Logout</a>
...
<?php /**PATH C:\xampp\htdocs\webdevs\bdflats\web\panel\resources\views/admin/layout/top_nav.blade.php ENDPATH**/ ?>