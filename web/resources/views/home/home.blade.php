    	...
    	<ol class="carousel-indicators">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('assets/img/slider/2.jpg')}}" class="d-block w-100" alt="image">
            </div>
            <div class="carousel-item">
                <img src="{{asset('assets/img/slider/1.jpg')}}" class="d-block w-100" alt="image">
            </div>
            <div class="carousel-item">
                <img src="{{asset('assets/img/slider/3.jpg')}}" class="d-block w-100" alt="image">
            </div>
          </div>
    </div>
</div>
...
<div class="category-sec">
     ...
     <div class="container">
          ...
          <div class="category-heading text-center">
              ...
              <p class="d-none d-md-block">Sed ut perspiciatis unde omnis uste natus error sit volupteatem <br/>Accusantium doloremque laudantium</p>
          </div>
          <!-- heading -->
         ...
         <div class="row">
            <div class="d-none d-md-block col-md-2 text-center">
                <div class="advertisement">
                    <a href="#"><img src="{{asset('assets/img/ads/verticle-ad.png')}}" alt="Images" class="img-fluid"></a>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <!-- category-item -->
                              <li class="category-item">
                                  <a href="categories.html">
                                      <div class="category-icon"><img src="{{asset('assets/img/icon/1.png')}}" alt="imags" class="img-fluid"></div>
                        ...
                        <div class="col-6 col-sm-3">
                            <!-- category-item -->
                              <li class="category-item">
                                  <a href="categories.html">
                                      <div class="category-icon"><img src="{{asset('assets/img/icon/2.png')}}" alt="imags" class="img-fluid"></div>
                        ...
                        <div class="col-6 col-sm-3">
                            <!-- category-item -->
                              <li class="category-item">
                                  <a href="categories.html">
                                      <div class="category-icon"><img src="{{asset('assets/img/icon/3.png')}}" alt="imags" class="img-fluid"></div>
                        ...
                        <div class="col-6 col-sm-3">
                            <!-- category-item -->
                              <li class="category-item">
                                  <a href="categories.html">
                                      <div class="category-icon"><img src="{{asset('assets/img/icon/4.png')}}" alt="imags" class="img-fluid"></div>
                         ...
                         <div class="col-6 col-sm-3">
                            <!-- category-item -->
                              <li class="category-item">
                                  <a href="categories.html">
                                      <div class="category-icon"><img src="{{asset('assets/img/icon/5.png')}}" alt="imags" class="img-fluid"></div>
                         ...
                         <div class="col-6 col-sm-3">
                            <!-- category-item -->
                              <li class="category-item">
                                  <a href="categories.html">
                                      <div class="category-icon"><img src="{{asset('assets/img/icon/6.png')}}" alt="imags" class="img-fluid"></div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                 <div class="featured-wrap">
                      <div class="featured-bx">
                          <a href="details.html"><img src="{{asset('assets/img/featured/1.jpg')}}" class="img-fluid" alt="image"></a>
                      </div>
            ...
            <div class="item">
                 <div class="featured-wrap">
                      <div class="featured-bx">
                          <a href="details.html"><img src="{{asset('assets/img/featured/2.jpg')}}" class="img-fluid" alt="image"></a>
                      </div>
                      <div class="featured-content">
                          <div class="featured-price">
                              <h3>TK 50.00</h3>
            ...
            <div class="item">
                 <div class="featured-wrap">
                      <div class="featured-bx">
                          <a href="details.html"><img src="{{asset('assets/img/featured/3.jpg')}}" class="img-fluid" alt="image"></a>
                      </div>
                      <div class="featured-content">
                          <div class="featured-price">
                              <h3>TK 50.00</h3>
            ...
            <div class="item">
                 <div class="featured-wrap">
                      <div class="featured-bx">
                          <a href="details.html"><img src="{{asset('assets/img/featured/4.jpg')}}" class="img-fluid" alt="image"></a>
                      </div>
                      <div class="featured-content">
                          <div class="featured-price">
                              <h3>TK 50.00</h3>
                        ...
                        <div class="row no-gutters position-relative">
                            <div class="col-4 col-md-5">
                                <div class="verified-bx">
                                    <a href="details.html"><img src="{{asset('assets/img/verified/5.jpg')}}" class="img-fluid" alt="image"></a>
                                </div>
                            </div>
                ...
                <div class="verified-product">
                    <div class="verified-wrap">
                        <div class="row no-gutters position-relative">
                            <div class="col-4 col-md-5">
                                <div class="verified-bx">
                                    <a href="details.html"><img src="{{asset('assets/img/verified/6.jpg')}}" class="img-fluid" alt="image"></a>
                                </div>
                            </div>
                            <div class="col-8 col-md-7 position-static">
                                <div class="verified-price">
                ...
                <div class="verified-product">
                    <div class="verified-wrap">
                        <div class="row no-gutters position-relative">
                            <div class="col-4 col-md-5">
                                <div class="verified-bx">
                                    <a href="details.html"><img src="{{asset('assets/img/verified/7.jpg')}}" class="img-fluid" alt="image"></a>
                                </div>
                            </div>
                            <div class="col-8 col-md-7 position-static">
                                <div class="verified-price">
                        ...
                        <div class="item">
                                ...
                                <div class="row no-gutters position-relative">
                                      <div class="col-5">
                                          <div class="category-bx">
                                              <a href="details.html"><img src="{{asset('assets/img/sale/1.jpg')}}" class="img-fluid" alt="image"></a>
                                          </div>
                                      </div>
                            ...
                            <div class="sale-product mb-3">
                                <div class="row no-gutters position-relative">
                                      <div class="col-5">
                                          <div class="category-bx">
                                              <a href="details.html"><img src="{{asset('assets/img/sale/2.jpg')}}" class="img-fluid" alt="image"></a>
                                          </div>
                                      </div>
                                      <div class="col-7 position-static pl-3">
                                          <div class="category-price">
                           ...
                           <!-- sale product -->
                            <div class="sale-product mb-3">
                                <div class="row no-gutters position-relative">
                                      <div class="col-5">
                                          <div class="category-bx">
                                              <a href="details.html"><img src="{{asset('assets/img/sale/3.jpg')}}" class="img-fluid" alt="image"></a>
                                          </div>
                                      </div>
                                      <div class="col-7 position-static pl-3">
                                          <div class="category-price">
                        ...
                        <div class="item">
                            ...
                            <div class="sale-product mb-3">
                                <div class="row no-gutters position-relative">
                                      <div class="col-5">
                                          <div class="category-bx">
                                              <a href="details.html"><img src="{{asset('assets/img/sale/4.jpg')}}" class="img-fluid" alt="image"></a>
                                          </div>
                                      </div>
                                      <div class="col-7 position-static pl-3">
                                          <div class="category-price">
        ...
        <div class="row text-center">
            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/1.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/2.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/3.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/4.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/5.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/6.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/7.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/8.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="developers">
                     <a href="#"><img src="{{asset('assets/img/developers/9.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>
    ...
    <!-- container -->
     <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-3 col-md-2 col-xl-1">
                 <div class="agencies">
                     <a href="#"><img src="{{asset('assets/img/agencies/10.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="agencies">
                     <a href="#"><img src="{{asset('assets/img/agencies/11.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>

            <div class="col-3 col-md-2 col-xl-1">
                 <div class="agencies">
                     <a href="#"><img src="{{asset('assets/img/agencies/12.jpg')}}" class="img-fluid" alt="image"></a>
                 </div>
            </div>
