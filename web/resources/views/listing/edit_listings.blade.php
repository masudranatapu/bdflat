            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                    ...
                    @elseif(Auth::user()->USER_TYPE == 3)
                        {!! Form::open([ 'route' => ['developer.listings.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
                    @elseif(Auth::user()->USER_TYPE == 4)
                        {!! Form::open([ 'route' => ['agency.listings.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
                    @else
                        {!! Form::open([ 'route' => ['agent.listings.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
                    @endif
                    ...
                    <div class="advertisment-wrap">
                        <div
                            ...
                            <div class="controls">
                                {!! Form::radio('property_for','sell', $row->PROPERTY_FOR=='sale'?true:false,[ 'id' => 'sell','data-validation-required-message' => 'This field is required']) !!}
