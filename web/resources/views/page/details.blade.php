                ...
                <div class="modal-body">
                    <div class="login-wrap text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p style="font-size: 20px;color: #FF3521;display: inline-block;margin-bottom: 25px !important;">Sorry ! you do not have sufficiant balance to buy this lead.</p>
                                <p>Your current balance</p>
                                <strong style="font-size: 28px;color: #3986FA;display: inline-block;margin-bottom: 25px !important;">BDT {{ number_format(Auth::user()->UNUSED_TOPUP,2) }}</strong>
                            </div>
                            <div class="col-12 form-group text-center">
                            ...
                            <div class="col-12">
                                ...
                                <p style="color: #6ABD50;font-weight: bold; margin-bottom: 25px !important;">If you want ot view the contact details including mobile number & address</p>
                                <p>Please Pay:</p>
                                <strong style="font-size: 28px;color: #FF3521;display: inline-block;margin-bottom: 25px !important;">BDT {{ number_format($listing->PRICE,2) }}</strong>
                                <p>Your current balance</p>
                                <strong style="font-size: 28px;color: #6ABD50;display: inline-block;margin-bottom: 25px !important;">BDT {{ number_format(Auth::user()->UNUSED_TOPUP,2) }}</strong>
                            </div>
