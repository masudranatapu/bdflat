...
class ListingController extends Controller
{
    ...
    public function store(ListingsRequest $request)
    {
        ...
        return redirect()->route('agency-listings')->with($this->resp->redirect_class, $this->resp->msg);
    }
...
//        return response()->json($data);
    ...
    public function pay($id)
    {
        ...
        return view('agency.pay', compact('data'));
    }
    ...
    public function payStore(Request $request, $id)
    {
        ...
        return redirect()->route('agency-listings');
    }
