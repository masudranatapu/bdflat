...
class ListingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('agent.create_listings', compact('data'));
    }
    ...
    public function store(ListingsRequest $request)
    {
        ...
        return redirect()->route('agent-listings')->with($this->resp->redirect_class, $this->resp->msg);
    }
    ...
    public function edit($id)
    {
        ...
        return view('agent.edit_listings', compact('data'));
    }

    public function addListingVariant(Request $request)
    {
        $data['html'] = view('agent._add_listing_variant', compact('request'))->render();
...
//        return response()->json($data);
    ...
    public function pay($id)
    {
        ...
        return view('agent.pay', compact('data'));
    }
