...
class ListingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('developer.create_listings', compact('data'));
    }
    ...
    public function store(ListingsRequest $request)
    {
        ...
        return redirect()->route('developer-listings')->with($this->resp->redirect_class, $this->resp->msg);
    }
    ...
    public function edit($id)
    {
        ...
        return view('developer.edit_listings', compact('data'));
    }

    public function addListingVariant(Request $request)
    {
        $data['html'] = view('developer._add_listing_variant', compact('request'))->render();
...
//        return response()->json($data);
    ...
    public function pay($id)
    {
        ...
        return view('developer.pay', compact('data'));
    }
    ...
    public function payStore(Request $request, $id)
    {
        ...
        return redirect()->route('developer-listings');
    }
