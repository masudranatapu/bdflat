<ul class="navigation navigation-main mt-1" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class="nav-item  @yield('Customer Management')"><a href="#"><i class="fas fa-users-cog"></i><span class="menu-title" data-i18n="@lang('left_menu.customer')">Customers</span></a>
        <ul class="menu-content">
            ...
            <li class="@yield('reseller_list')"><a class="menu-item" href="{{route('admin.reseller.list')}}"><i></i><span data-i18n="@lang('left_menu.reseller_list')">Vendor List</span></a></li>
            @endif
            @if(hasAccessAbility('view_shopcategory', $roles))
            <li class="@yield('shop category')"><a class="menu-item" href="{{route('admin.shop.category.list')}}"><i></i><span data-i18n="@lang('left_menu.shopcategory_list')">Shop Category</span></a></li>
            @endif
