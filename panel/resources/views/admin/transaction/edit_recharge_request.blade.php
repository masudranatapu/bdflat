                        ...
                        <div class="card-body">
                            <div class="row  mb-2">
                                <div class="col-12">
                                    ...
                                    <p><strong>Attachment: </strong>{{ $data['recharge']->ATTACHMENT_PATH ? asset($data['recharge']->ATTACHMENT_PATH) : 'N/A' }}</p>
                                    <hr>
                                    {!! Form::open([ 'route' => ['admin.recharge_request.update', $data['recharge']->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => false , 'novalidate']) !!}
                                    <div class="row">
