                        ...
                        <div class="card-body">
                            <div class="row  mb-2">
                                <div class="col-12">
                                    ...
                                    <p><strong>Requested At: </strong>{{ date('M d, Y h:i a', strtotime($data['refund']->REQUEST_AT)) }}</p>
                                    <p><strong>Purchase At: </strong>{{ date('M d, Y h:i a', strtotime($data['refund']->PURCHASE_DATE)) }}</p>
                                    <p><strong>Refund Request Reason: </strong>{{ $data['refund']->REQUEST_REASON }}</p>
                                    <p><strong>Comments: </strong>{{ $data['refund']->COMMENT }}</p>
                                    <p><strong>Request Amount: </strong>BDT {{ number_format($data['refund']->REQUEST_AMOUNT, 2) }}</p>
                                    <hr>
