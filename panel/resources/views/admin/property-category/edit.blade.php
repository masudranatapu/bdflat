                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                               <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                                  <label class="text-uppercase">PROPERTY TYPE<span class="text-danger">*</span></label>
                                                  <div class="controls">
                                                     {!! Form::text('category_name', $category->PROPERTY_TYPE, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter category name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group {!! $errors->has('meta_description') ? 'error' : '' !!}">
                                             ...
                                             <div class="controls">
                                                {!! Form::textarea('meta_description', $category->META_DESC, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter meta description', 'tabindex' => 7,'rows'=>'4','cols'=>'10' ]) !!}
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group {!! $errors->has('body_description') ? 'error' : '' !!}">
                                             ...
                                             <div class="controls">
                                                {!! Form::textarea('body_description', $category->BODY_DESC, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter body description', 'tabindex' => 7,'rows'=>'4','cols'=>'10' ]) !!}
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group {!! $errors->has('null') ? 'error' : '' !!}">
                                             <label>URL</label>
                                             <div class="controls">
                                                {!! Form::text('url', $category->CATEGORY_URL, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter url', 'tabindex' => 5]) !!}
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group {!! $errors->has('order') ? 'error' : '' !!}">
                                             ...
                                             <div class="controls">
                                                {!! Form::text('order', $category->ORDER_ID, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter order', 'tabindex' => 5]) !!}
                                         ...
                                         <div class="row">
                                            <div class="col-md-4">
                                               <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                                  ...
                                                  <div class="controls">
                                                     <div class="fileupload @if(!empty($category->IMG_PATH))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif " data-provides="fileupload" >
                                                        ...
                                                        <img src="{{asset($category->IMG_PATH)}}" alt="Photo" class="img-fluid" height="150px" width="120px"/>
                                                        @endif
                                                        </span>
                                                        <span>
                                                        ...
                                                        {!! Form::file('image', Null,[ 'class' => 'form-control mb-1', 'tabindex' => 8]) !!}
                                                        </label>
                                            ...
                                            <div class="col-md-4">
                                               <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                                  ...
                                                  <div class="controls">
                                                     <div class="fileupload @if(!empty($category->ICON_PATH))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif " data-provides="fileupload" >
                                                        <span class="fileupload-preview fileupload-exists thumbnail" style="max-width: 150px; max-height: 120px;">
                                                        @if(!empty($category->ICON_PATH))
                                                        <img src="{{asset($category->ICON_PATH)}}" alt="Photo" class="img-fluid" height="150px" width="120px"/>
                                                        @endif
                                                        </span>
                                                        <span>
                                                        <label class="btn btn-primary btn-rounded btn-file btn-sm">
                                                        ...
                                                        {!! Form::file('icon', Null,[ 'class' => 'form-control mb-1', 'tabindex' => 9]) !!}
                                                        </label>
                                                        <a href="#" class="btn fileupload-exists btn-default btn-rounded  btn-sm" data-dismiss="fileupload" id="remove-thumbnail">
                                                        <i class="la la-times"></i> Remove
                                                        </a>
