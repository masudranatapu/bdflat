                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {!! $errors->has('category_name') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('category_name', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter category name', 'tabindex' => 5]) !!}
                     ...
                     <div class="col-md-12">
                        <div class="form-group {!! $errors->has('body_description') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::textarea('body_description', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter body description', 'tabindex' => 7,'rows'=>'4','cols'=>'10' ]) !!}
                     ...
                     <div class="col-md-12">
                        <div class="form-group {!! $errors->has('null') ? 'error' : '' !!}">
                           <label>URL</label>
                           <div class="controls">
                              {!! Form::text('url', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter url', 'tabindex' => 5]) !!}
                     ...
                     <div class="col-md-12">
                        <div class="form-group {!! $errors->has('order') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('order', null, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter order', 'tabindex' => 5]) !!}
                        ...
                        <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              <div class="fileupload fileupload-new" data-provides="fileupload" >
                                 ...
                                 {!! Form::file('image', Null,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS ACTIVE', 'tabindex' => 8]) !!}
                                 </label>
