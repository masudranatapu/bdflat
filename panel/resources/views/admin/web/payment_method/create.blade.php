                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group {!! $errors->has('payment_method_name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('payment_method_name', null,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Payment Method Name', 'tabindex' => 1 ]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group {!! $errors->has('status') ? 'status' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::select('status',['1'=>'Active','0'=>'Inactive'],null,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Select Status' ]) !!}
