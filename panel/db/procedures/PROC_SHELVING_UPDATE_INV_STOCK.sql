CREATE PROCEDURE PROC_SHELVING_UPDATE_INV_STOCK(shelve_label VarChar(20), IN_INV_SHELVING_ARRAY VarChar(1024), IN_ROW_COUNT Integer, IN_COL_PARAMETERS Integer, IN_COLUMN_SEPARATOR VarChar(1), IN_ROW_SEPARATOR VarChar(1), USER_ID Integer, IS_UPDATE Integer, OUT OUT_STATUS VarChar(20))
  NO SQL
BEGIN
